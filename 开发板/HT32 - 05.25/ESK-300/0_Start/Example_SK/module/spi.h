...
#define WIFI_CPIO_PORT1  		_WIFI_CPIO_PORT1
#define WIFI_CPIO_PORT2  		_WIFI_CPIO_PORT2
#define WIFI_HT_CPIO_PORT1  _WIFI_HT_CPIO_PORT1
#define WIFI_HT_CPIO_PORT2  _WIFI_HT_CPIO_PORT2

#define SCK_PIN 			_SCK_PIN
#define CS_PIN			  _CS_PIN
#define MOSI_PIN 			_MOSI_PIN
#define MISO_PIN			_MISO_PIN
//#define INT_PIN			  _INT_PIN
#define RESET_PIN			_RESET_PIN
/************************(代码移植需改动)************************************/
#define WIFI_CS_Dis()             { GPIO_WriteOutBits(WIFI_HT_CPIO_PORT1,CS_PIN, SET); }
#define WIFI_CS_EN()              { GPIO_WriteOutBits(WIFI_HT_CPIO_PORT1,CS_PIN, RESET);}

#define WIFI_SCK_H 		 CPIO_OUT_BITS(WIFI_HT_CPIO_PORT1,SCK_PIN, SET)
#define WIFI_SCK_L		 CPIO_OUT_BITS(WIFI_HT_CPIO_PORT1,SCK_PIN, RESET)
#define WIFI_MOSI_H 	 CPIO_OUT_BITS(WIFI_HT_CPIO_PORT1,MOSI_PIN, SET)
#define WIFI_MOSI_L		 CPIO_OUT_BITS(WIFI_HT_CPIO_PORT1,MOSI_PIN, RESET)
#define WIFI_MISO 		 CPIO_IN_BITS(WIFI_HT_CPIO_PORT1, MISO_PIN)
#define WIFI_INT       CPIO_IN_BITS(WIFI_HT_CPIO_PORT2, INT_PIN)
